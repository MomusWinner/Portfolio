...
export function addTimeIntervalRoutes(
  timeIntervalHandle: TimeIntervalHandler,
  ...
  app.get(
    ...
    timeIntervalHandle.getTimeIntervalBySessionIDAndDayHandle()
  );
  app.get(
    "/session/:id",
    authMiddleware.handle(),
    timeIntervalHandle.getTimeIntervalBySessionIDHandle()
  );
